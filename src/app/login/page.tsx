  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-bl from-emerald-600 via-emerald-600 to-teal-500 px-5 py-10">
      ...
      <div className="relative w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl md:p-10">
        ...
        <h1 className="mt-6 text-2xl font-black text-slate-900">{t("loginTitle")}</h1>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pe-11 ps-10 text-sm outline-none transition focus:border-emerald-500 focus:bg-white"
                required
              />
              <button
                type="button"
